...
set enable_m_src_axi_debug 0
if {[info exists ::env(ENABLE_M_SRC_AXI_DEBUG)]} {
  set enable_m_src_axi_debug [expr {$::env(ENABLE_M_SRC_AXI_DEBUG) ne "" && $::env(ENABLE_M_SRC_AXI_DEBUG) ne "0"}]
}

set hw69_tx_files [concat \
  [glob -nocomplain [file join [pwd] rtl tx *.v]] \
  [glob -nocomplain [file join [pwd] rtl tx *.sv]]
]
if {[llength $hw69_tx_files] > 0} {
  add_files -norecurse -fileset sources_1 $hw69_tx_files
...
create_bd_cell -type module -reference hw69_tx_dma_modulator_wrapper hw69_tx_mod


  ad_ip_instance ila m_src_axi_debug_ila
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_MONITOR_TYPE Native
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_ENABLE_ILA_AXI_MON false
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_NUM_OF_PROBES 10
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE0_WIDTH 30
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE1_WIDTH 4
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE2_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE3_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE4_WIDTH 64
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE5_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE6_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE7_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE8_WIDTH 2
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_PROBE9_WIDTH 1
  ad_ip_parameter m_src_axi_debug_ila CONFIG.C_DATA_DEPTH 1024
...
# TX datapath: DDR -> axi_ad9361_dac_dma -> hw69_tx_mod -> axi_ad9361
ad_connect  axi_ad9361/l_clk hw69_tx_mod/axis_aclk
ad_connect  axi_ad9361/rst hw69_tx_mod/axis_rst
ad_connect  axi_ad9361_dac_dma/m_axis hw69_tx_mod/s_axis
ad_connect  axi_ad9361/l_clk axi_ad9361_dac_dma/m_axis_aclk
ad_connect  axi_ad9361/dac_valid_i0 hw69_tx_mod/tx_sample_strobe
ad_connect  hw69_tx_mod/tx_i0 axi_ad9361/dac_data_i0
ad_connect  hw69_tx_mod/tx_q0 axi_ad9361/dac_data_q0
ad_connect  hw69_tx_mod/tx_i1 axi_ad9361/dac_data_i1
ad_connect  hw69_tx_mod/tx_q1 axi_ad9361/dac_data_q1
ad_connect  hw69_tx_mod/tx_underflow axi_ad9361/dac_dunf
ad_connect  GND axi_ad9361/adc_dovf
ad_connect  axi_ad9361/dac_enable_i0 hw69_tx_mod/control_enable
ad_connect  GND hw69_tx_mod/control_restart
...
ad_connect sys_cpu_resetn axi_ad9361_dac_dma/m_src_axi_aresetn
  ...
  ad_connect sys_cpu_clk m_src_axi_debug_ila/clk
  ad_connect axi_ad9361_dac_dma/m_src_axi_araddr m_src_axi_debug_ila/probe0
  ad_connect axi_ad9361_dac_dma/m_src_axi_arlen m_src_axi_debug_ila/probe1
  ad_connect axi_ad9361_dac_dma/m_src_axi_arvalid m_src_axi_debug_ila/probe2
  ad_connect sys_ps7/S_AXI_HP2_ARREADY m_src_axi_debug_ila/probe3
  ad_connect sys_ps7/S_AXI_HP2_RDATA m_src_axi_debug_ila/probe4
  ad_connect sys_ps7/S_AXI_HP2_RVALID m_src_axi_debug_ila/probe5
  ad_connect axi_ad9361_dac_dma/m_src_axi_rready m_src_axi_debug_ila/probe6
  ad_connect sys_ps7/S_AXI_HP2_RLAST m_src_axi_debug_ila/probe7
  ad_connect sys_ps7/S_AXI_HP2_RRESP m_src_axi_debug_ila/probe8
  ad_connect axi_ad9361_dac_dma/irq m_src_axi_debug_ila/probe9
